...
export const defaultCMSContent: CMSContentState = {
  ...
  portals: [
    { name: 'GeM', full: 'Government e-Marketplace', category: 'Central Goods & Services', domain: 'gem.gov.in', color: '#0D9488', status: 'Direct API & Cataloging' },
    { name: 'CPPP', full: 'Central Public Procurement', category: 'Central Ministries & PSUs', domain: 'eprocure.gov.in', color: '#0284C7', status: 'Daily Scrape & Bid Alerts' },
    { name: 'GePNIC', full: 'NIC e-Procurement Portal', category: 'National Informatics Centre', domain: 'gepnic.gov.in', color: '#4F46E5', status: 'DSC Token Support' },
    { name: 'MSTC', full: 'PSU e-Auctions & Tenders', category: 'Raw Materials & Scrap', domain: 'mstcecommerce.com', color: '#7E22CE', status: 'Reverse Auction Assistance' },
    { name: 'IREPS', full: 'Indian Railways E-Procurement', category: 'Rail Stores & Works', domain: 'ireps.gov.in', color: '#0E7490', status: 'Vendor Approval Tracking' },
    { name: 'State eTenders', full: 'State Government Portals', category: '28+ States & UTs Nationwide', domain: 'etenders.gov.in', color: '#059669', status: 'Local Preference & PWD' },
    { name: 'PSU Portals', full: 'Direct CPSE Desks', category: 'ONGC, BHEL, NTPC, IOCL', domain: 'cpse-tenders.in', color: '#B45309', status: 'Turnkey BOQ Costing' },
  ],
  trustBar: [
    { title: 'End-to-End Support', desc: 'From onboarding and tender discovery to submission and post-award assistance.', color: '#0D9488' },
    { title: 'Tender-Focused Guidance', desc: 'Understand what to prepare and what to expect before you invest time bidding.', color: '#6366F1' },
    { title: 'Document Support', desc: 'Assistance organising, compiling and preparing the documents each tender requires.', color: '#8B5CF6' },
    { title: 'Portal Assistance', desc: 'Support across GeM, CPPP, state eTender portals and PSU procurement platforms.', color: '#0891B2' },
    { title: 'Human Consultation', desc: 'Speak directly with a tender professional when you need context or guidance.', color: '#10B981' },
  ],
  problemItems: [
  ...
  whyUsItems: [
    { title: 'Pre-Bid Eligibility Auditing', desc: 'Before investing weeks in bid prep, we verify your turnover, past work orders, and technical specs against the tender qualification sheet.', color: '#0D9488' },
    { title: 'Multi-Portal Desk Operations', desc: 'Deep familiarity with GeM 4.0, CPPP (eProcure), IREPS, GePNIC, and state eTender portals. Zero confusion over conflicting portal parameters.', color: '#0891B2' },
    ...
    { title: 'Direct Consultant Access', desc: 'No generic ticket queues. Speak directly with experienced tender coordinators via dedicated WhatsApp group and direct call.', color: '#EC4899' },
  ],
  faqs: faqData.map(f => ({
    id: f.id,
    question: f.question,
